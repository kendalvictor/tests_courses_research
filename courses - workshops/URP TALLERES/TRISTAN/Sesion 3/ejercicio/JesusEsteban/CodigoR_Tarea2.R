...
setwd('D:/Maestria Ciencia de Datos/IV Semestre/Analisis de Texto')
######forma 2###########
library(tidyverse)
library(dplyr)
library(tm)
...
sw <- readLines("D:/Maestria Ciencia de Datos/IV Semestre/Analisis de Texto/stopwordses.txt",encoding="UTF-8")
